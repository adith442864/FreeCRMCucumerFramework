...
public class TaggingStepDefinition {
	...
	public void this_is_search_deal_test() {
	}

	@Given("^This is search contact test$")
	public void this_is_search_contact_test() {
	    
	}

	@Given("^This is search case test$")
	public void this_is_search_case_test() {
	    
	}

	@Given("^This is search call test$")
	public void this_is_search_call_test()  {
	   
	}

	@Given("^This is search email test$")
	public void this_is_search_email_test()  {
	   
	}

	@Given("^This is search docs test$")
	public void this_is_search_docs_test()  {
	    
	}

	@Given("^This is search forms test$")
	public void this_is_search_forms_test() {
	...
	public void this_is_close_browser_test() {
	}
